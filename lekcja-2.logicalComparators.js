...
// console.log(
//   "Comparing variable boolean with object field",
//   primitiveBool === anotherNonPrimitiveObject.primitiveFieldBoolean
// );
...
const DojebanyKurwaWrapperZebyNiktNieZnalazlJuzTamtejTablicy = {
  pole1: {
    pole2: {
      jakasTablica: ["a", "b", WrapperToHideArray],
    },
  },
};
...
console.log(isNumberGreaterThanBoolean);
...
const isCallEqualToCallForObjectPointerArg =
  myFunctionClone(pointerToSameObject) === justGiveMeBackMyArgument(pointerToSameObject);
...
function resolveSurname(child, childGender) {
  if (childGender == possibleGenders[0])
...
console.log(
  `Surname for girl with fathers eyes is Nowak-Kowalski. ${resolveSurname(girlWithFathersEyes) === "Nowak-Kowalski"}`
);
